...
:::caution[The encryption method may vary, based on the file format]
...
:::caution[Specify input and output types]

As with encryption, you need to specify the input type when decrypting files. This ensures that SOPS knows how to handle the file correctly.
